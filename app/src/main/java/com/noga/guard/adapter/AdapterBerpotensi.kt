package com.noga.guard.adapter
...
import com.noga.guard.fragment.FragmentDetailGempa
import com.noga.guard.model.ModelGempaBerpotensi
import java.text.ParseException
import java.text.SimpleDateFormat

class AdapterBerpotensi (private val modelGempaBerpotensi: List<ModelGempaBerpotensi>) : RecyclerView.Adapter<AdapterBerpotensi.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_gempa_berpotensi, parent, false)
